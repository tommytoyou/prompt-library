        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 text-center">
          ...
          <div className="relative max-w-xl mx-auto">
            ...
            <input
              ...
              className="w-full bg-stone-800 border border-stone-700 text-stone-300 placeholder-stone-500 rounded-xl pl-12 pr-28 py-4 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
            />
            <div className="absolute inset-y-0 right-2 flex items-center">
              <button className="bg-amber-500 hover:bg-amber-600 text-stone-900 font-semibold text-sm px-4 py-2 rounded-lg transition-colors">
                Search
              </button>
            </div>
          </div>
          <p className="text-stone-600 text-xs mt-3">Search coming soon — browse by category below</p>
        </div>
      </section>
